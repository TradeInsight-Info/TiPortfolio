...
Defines the `--select` CLI option that controls which assets are selected for rebalancing, including the default (all), explicit all, and momentum-based selection.
