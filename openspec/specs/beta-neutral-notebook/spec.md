...
Specification for the beta-neutral dynamic notebook that demonstrates `BetaScreenerStrategy` using a long/short portfolio selected by rolling OLS beta rank.
