# Spec: CSV Offline Data

## Purpose

Describes requirements for using local CSV files as an offline data source in `fetch_data`, enabling examples and tests to run without network access.
