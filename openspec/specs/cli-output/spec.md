...
Defines the CLI output options: default summary, full extended summary, plot file generation, and leverage application (single or list for side-by-side comparison).
