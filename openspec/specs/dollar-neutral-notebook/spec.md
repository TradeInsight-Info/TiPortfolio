# Spec: dollar-neutral-notebook

## Purpose

Demonstrates a dollar-neutral long/short pair trade (TXN long / KVUE short) using a parent/child portfolio tree with controlled book sizes.
