# Spec: signal-indicator

## Purpose

Provides a `Signal.Indicator` algo that fires on condition crossovers (up, down, or both) based on a user-supplied condition function evaluated over a lookback window of close prices.
